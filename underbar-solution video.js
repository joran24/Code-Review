(function() {
  ...
  // Inefficient: Quadractic Time Complexity (n iterations of n elements)
...
// Breadcrumbing solution using an object as intermediate storage solution
_.uniq = function(array) {
  // Objects have Constant Time Lookup in relation to Time Complexity
  var unique = {}, results = [];
...
_.uniq = function(array, isSorted, iterator) {
  ...
  _.reduce = function(collection, iterator, accumulator) {
    var uninitalized = arguments.length === 2;
  ...
  _.defaults = function(obj) {
    _.each(arguments, function(arguement) {
      _.each(arguement, function(value, key) {
